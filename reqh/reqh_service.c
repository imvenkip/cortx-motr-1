...
//XXX_BE_DB 	m0_rpc_service_reverse_session_put(&service->rs_rpc_svc);
...
{
//XXX_BE_DB 	m0_rpc__service_fini(service);
...
//XXX_BE_DB 	ep = m0_rpc_machine_ep(rmach);
//XXX_BE_DB 	m0_rpc_service_alloc_and_init(&reqh_rpc_svct, ep, &uuid1, &rpcsvc);
...
M0_INTERNAL void m0_reqh_service_fini(struct m0_reqh_service *service)
{
	...
	m0_sm_group_unlock(&service->rs_reqh->rh_sm_grp);
//XXX_BE_DB 	m0_rpc_service_fini_and_free(&service->rs_rpc_svc);
