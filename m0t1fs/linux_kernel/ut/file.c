...
static char local_conf[] = "[43:\
   ...
   {0x6e| ((^n|1:2), 16000, 2, 3, 2, ^o|1:23,\
           [2: ^r|1:3, ^r|2:3])},\
   {0x72| ((^r|1:3), [1:3], 0, 0, 0, 0, \""LOCAL_EP"\", [7: ^s|1:4,\
                                                   ^s|1:5,\
                                                   ^s|1:6,\
                                                   ^s|1:7,\
                                                   ^s|1:8,\
   ...
   {0x73| ((^s|1:6), @M0_CST_MGS, [3: \""LOCAL_EP"\", \"addr-1\", \"addr-2\"],\
           [0])},\
   ...
   {0x73| ((^s|1:40), @M0_CST_FDMI, [3: \""LOCAL_EP"\", \"addr-1\", \"addr-2\"],\
           [0])},\
