...
M0_TL_DESCR_DECLARE(hi, M0_INTERNAL);
M0_TL_DECLARE(hi, M0_INTERNAL, struct m0_dtm_up);
M0_TL_DESCR_DECLARE(op, , M0_INTERNAL, struct m0_dtm_up);
M0_TL_DECLARE(op, M0_INTERNAL, struct m0_dtm_up);
...
M0_TL_DESCR_DECLARE(history, M0_INTERNAL);
M0_TL_DECLARE(history, M0_INTERNAL, struct m0_dtm_update);
M0_TL_DESCR_DECLARE(oper, M0_INTERNAL);
M0_TL_DECLARE(oper, M0_INTERNAL, struct m0_dtm_up);
