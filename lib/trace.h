...
#define M0_TRACE_SUBSYSTEMS      \
  ...
  M0_TRACE_SUBSYS(FD,        14) \
  M0_TRACE_SUBSYS(FILE,      15) \
  M0_TRACE_SUBSYS(FOL,       16) \
  M0_TRACE_SUBSYS(FOP,       17) \
  M0_TRACE_SUBSYS(FORMATION, 18) \
  M0_TRACE_SUBSYS(HA,        19) \
  M0_TRACE_SUBSYS(IOSERVICE, 20) \
  M0_TRACE_SUBSYS(LAYOUT,    21) \
  M0_TRACE_SUBSYS(LNET,      22) \
  M0_TRACE_SUBSYS(M0D,       23) \
  M0_TRACE_SUBSYS(M0T1FS,    24) \
  M0_TRACE_SUBSYS(MDS,       25) \
  M0_TRACE_SUBSYS(MEMORY,    26) \
  M0_TRACE_SUBSYS(MGMT,      27) \
  M0_TRACE_SUBSYS(NET,       28) \
  M0_TRACE_SUBSYS(POOL,      29) \
  M0_TRACE_SUBSYS(RM,        30) \
  M0_TRACE_SUBSYS(RPC,       31) \
  M0_TRACE_SUBSYS(SM,        32) \
  M0_TRACE_SUBSYS(SNS,       33) \
  M0_TRACE_SUBSYS(SNSCM,     34) \
  M0_TRACE_SUBSYS(SPIEL,     35) \
  M0_TRACE_SUBSYS(SSS,       36) \
  M0_TRACE_SUBSYS(STATS,     37) \
  M0_TRACE_SUBSYS(STOB,      38) \
  M0_TRACE_SUBSYS(XCODE,     39)
