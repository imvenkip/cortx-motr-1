...
#define M0_TRACE_SUBSYSTEMS      \
  ...
  M0_TRACE_SUBSYS(CM,         9) \
  M0_TRACE_SUBSYS(COB,       10) \
  M0_TRACE_SUBSYS(CONF,      11) \
  M0_TRACE_SUBSYS(CONSOLE,   12) \
  M0_TRACE_SUBSYS(DTM,       13) \
  M0_TRACE_SUBSYS(EXTMAP,    14) \
  M0_TRACE_SUBSYS(FD,        15) \
  M0_TRACE_SUBSYS(FILE,      16) \
  M0_TRACE_SUBSYS(FOL,       17) \
  M0_TRACE_SUBSYS(FOP,       18) \
  M0_TRACE_SUBSYS(FORMATION, 19) \
  M0_TRACE_SUBSYS(HA,        20) \
  M0_TRACE_SUBSYS(IOSERVICE, 21) \
  M0_TRACE_SUBSYS(LAYOUT,    22) \
  M0_TRACE_SUBSYS(LNET,      23) \
  M0_TRACE_SUBSYS(M0D,       24) \
  M0_TRACE_SUBSYS(M0T1FS,    25) \
  M0_TRACE_SUBSYS(MDS,       26) \
  M0_TRACE_SUBSYS(MEMORY,    27) \
  M0_TRACE_SUBSYS(MGMT,      28) \
  M0_TRACE_SUBSYS(NET,       29) \
  M0_TRACE_SUBSYS(POOL,      30) \
  M0_TRACE_SUBSYS(RM,        31) \
  M0_TRACE_SUBSYS(RPC,       32) \
  M0_TRACE_SUBSYS(SM,        33) \
  M0_TRACE_SUBSYS(SNS,       34) \
  M0_TRACE_SUBSYS(SNSCM,     35) \
  M0_TRACE_SUBSYS(SPIEL,     36) \
  M0_TRACE_SUBSYS(SSS,       37) \
  M0_TRACE_SUBSYS(STATS,     38) \
  M0_TRACE_SUBSYS(STOB,      39) \
  M0_TRACE_SUBSYS(XCODE,     40) \
  M0_TRACE_SUBSYS(CLOVIS,    41)
