...
#define M0_TRACE_SUBSYSTEMS      \
  ...
  M0_TRACE_SUBSYS(DTM,       15) \
  M0_TRACE_SUBSYS(EXTMAP,    16) \
  M0_TRACE_SUBSYS(FD,        17) \
  M0_TRACE_SUBSYS(FILE,      18) \
  M0_TRACE_SUBSYS(FOL,       19) \
  M0_TRACE_SUBSYS(FOP,       20) \
  M0_TRACE_SUBSYS(FORMATION, 21) \
  M0_TRACE_SUBSYS(HA,        22) \
  M0_TRACE_SUBSYS(IOSERVICE, 23) \
  M0_TRACE_SUBSYS(LAYOUT,    24) \
  M0_TRACE_SUBSYS(LNET,      25) \
  M0_TRACE_SUBSYS(M0D,       26) \
  M0_TRACE_SUBSYS(M0T1FS,    27) \
  M0_TRACE_SUBSYS(MDS,       28) \
  M0_TRACE_SUBSYS(MEMORY,    29) \
  M0_TRACE_SUBSYS(MGMT,      30) \
  M0_TRACE_SUBSYS(NET,       31) \
  M0_TRACE_SUBSYS(POOL,      32) \
  M0_TRACE_SUBSYS(RM,        33) \
  M0_TRACE_SUBSYS(RPC,       34) \
  M0_TRACE_SUBSYS(SM,        35) \
  M0_TRACE_SUBSYS(SNS,       36) \
  M0_TRACE_SUBSYS(SNSCM,     37) \
  M0_TRACE_SUBSYS(SPIEL,     38) \
  M0_TRACE_SUBSYS(SSS,       39) \
  M0_TRACE_SUBSYS(STATS,     40) \
  M0_TRACE_SUBSYS(STOB,      41) \
  M0_TRACE_SUBSYS(XCODE,     42)
