...
C2_INTERNAL bool c2_list_invariant(const struct c2_list *head)
{
...
C2_INTERNAL void c2_list_move(struct c2_list *head, struct c2_list_link *old)
{
	__c2_list_del(old);
