...
enum c2_addb_event_id {
	...
	C2_ADDB_EVENT_LAYOUT_DECODE_SUCCESS = 0x31ULL,
	C2_ADDB_EVENT_LAYOUT_DECODE_FAIL    = 0x32ULL,
	C2_ADDB_EVENT_LAYOUT_ENCODE_SUCCESS = 0x33ULL,
	C2_ADDB_EVENT_LAYOUT_ENCODE_FAIL    = 0x34ULL,

	C2_ADDB_EVENT_LAYOUT_LOOKUP_SUCCESS = 0x35ULL,
	C2_ADDB_EVENT_LAYOUT_LOOKUP_FAIL    = 0x36ULL,
	C2_ADDB_EVENT_LAYOUT_ADD_SUCCESS    = 0x37ULL,
	C2_ADDB_EVENT_LAYOUT_ADD_FAIL       = 0x38ULL,
	C2_ADDB_EVENT_LAYOUT_UPDATE_SUCCESS = 0x39ULL,
	C2_ADDB_EVENT_LAYOUT_UPDATE_FAIL    = 0x40ULL,
	C2_ADDB_EVENT_LAYOUT_DELETE_SUCCESS = 0x41ULL,
	C2_ADDB_EVENT_LAYOUT_DELETE_FAIL    = 0x42ULL,
