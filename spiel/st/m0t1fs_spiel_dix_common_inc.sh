...
DIXINIT_TOOL_CREATE="-a create"
DIXINIT_TOOL_CHECK="-a check"
DIXINIT_TOOL_DESTROY="-a destroy"
DIXINIT_TOOL_CREATE="$DIXINIT_TOOL $DIXINIT_TOOL_OPTS $DIXINIT_TOOL_CREATE"
DIXINIT_TOOL_CHECK="$DIXINIT_TOOL $DIXINIT_TOOL_OPTS $DIXINIT_TOOL_CHECK"
DIXINIT_TOOL_DESTROY="$DIXINIT_TOOL $DIXINIT_TOOL_OPTS $DIXINIT_TOOL_DESTROY"
...
spiel_prepare()
{
	...
	local SPIEL_CLIENT_ENDPOINT="$LNET_NID:12345:34:2001"
