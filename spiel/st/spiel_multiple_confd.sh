...
(service-6 type=@M0_CST_RMS endpoints=["$M0D2_ENDPOINT"] sdevs=[])
(service-7 type=@M0_CST_CONFD endpoints=["$M0D2_ENDPOINT"] sdevs=[])
(service-8 type=@M0_CST_RMS endpoints=["$M0D3_ENDPOINT"] sdevs=[])
(service-9 type=@M0_CST_CONFD endpoints=["$M0D3_ENDPOINT"] sdevs=[])
