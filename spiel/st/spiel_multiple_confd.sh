...
(service-6 type=4 endpoints=["$M0D2_ENDPOINT"] sdevs=[])
(service-7 type=3 endpoints=["$M0D2_ENDPOINT"] sdevs=[])
(service-8 type=4 endpoints=["$M0D3_ENDPOINT"] sdevs=[])
(service-9 type=3 endpoints=["$M0D3_ENDPOINT"] sdevs=[])
