...
*/
		...
		// GETPUT { "group_format",            m0_be_ut_group_format            },
		{ "mkfs",                    m0_be_ut_mkfs                    },
...
// XXX		{ "tx-force",                m0_be_ut_tx_force                },
		...
		// GETPUT { "tx_bulk-error_payload",   m0_be_ut_tx_bulk_error_payload   },
		// GETPUT { "tx_bulk-large_tx",        m0_be_ut_tx_bulk_large_tx        },
		// GETPUT { "tx_bulk-large_payload",   m0_be_ut_tx_bulk_large_payload   },
		// GETPUT { "tx_bulk-large_all",       m0_be_ut_tx_bulk_large_all       },
		// GETPUT { "tx_bulk-small_tx",        m0_be_ut_tx_bulk_small_tx        },
		// GETPUT { "tx_bulk-medium_tx",       m0_be_ut_tx_bulk_medium_tx       },
		// GETPUT { "tx_bulk-medium_tx_multi", m0_be_ut_tx_bulk_medium_tx_multi },
		// GETPUT { "tx_bulk-medium_cred",     m0_be_ut_tx_bulk_medium_cred     },
		// GETPUT { "tx_bulk-large_cred",      m0_be_ut_tx_bulk_large_cred      },
		...
		// GETPUT { "alloc-concurrent",        m0_be_ut_alloc_concurrent        },
