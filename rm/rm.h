...
enum c2_rm_incoming_flags {
	...
	RIF_LOCAL_TRY  = (1 << 3),
	/**
	 * This flag is used for an incoming request generated by the owner.
	 * RM-API user should never use this flag. This flag is used during
	 * finalisation of the owner so that user requests can be distinguished.
	 */
	RIF_INTERNAL  = (1 << 4),
};
