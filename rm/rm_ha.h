...
struct m0_rm_ha_tracker {
	...
	char                   *rht_ep;
	/**
	 * Can be used by tracker user to schedule reaction on remote's death.
	 */
	struct m0_sm_ast        rht_dead_ast;
	/**
	 * Can be used by tracker user when remote is announced to be online.
	 */
	struct m0_sm_ast        rht_online_ast;
};
