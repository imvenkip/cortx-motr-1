...
static const struct command_descr commands[] = {
	...
	{ GENF, "genf",   "genf CNT FIDFILE, generate file with several FID" },
	{ GENV, "genv",   "genv CNT VFILE, generate file with several values" },
};
...
void index_parser_print_command_help(void)
{
	...
	m0_console_printf(
		...
		"\t- FID - value in m0_fid_sscanf format, e.g. '1:5' and etc\n"
		...
		"0x07,0x08,0x09]\"\n"
		"\t\t>m0clovis [common args] index drop \"1:5\" create "
		"\"1:5\" put \"1:5\" @keys.txt @vals.txt\n");
}
