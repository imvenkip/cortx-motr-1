...
int main(int argc, char **argv)
{
	...
	if (argc < 7) {
		printf("Usage: clovis_touch laddr ha_addr "
		       "prof_opt proc_fid index_dir object_id\n");
		return -1;
	}
