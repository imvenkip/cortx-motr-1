...
C2_INTERNAL bool c2_rpc_packet_invariant(const struct c2_rpc_packet *packet);
C2_INTERNAL void c2_rpc_packet_init(struct c2_rpc_packet *packet);
C2_INTERNAL void c2_rpc_packet_fini(struct c2_rpc_packet *packet);

/**
   @pre  !packet_item_tlink_is_in(item)
   @post c2_rpc_packet_is_carrying_item(packet, item)
 */
C2_INTERNAL void c2_rpc_packet_add_item(struct c2_rpc_packet *packet,
 ...
 */
C2_INTERNAL void c2_rpc_packet_remove_item(struct c2_rpc_packet *packet,
					   struct c2_rpc_item *item);

/**
   @post c2_rpc_packet_is_empty(packet)
 */
C2_INTERNAL void c2_rpc_packet_remove_all_items(struct c2_rpc_packet *packet);

C2_INTERNAL bool c2_rpc_packet_is_empty(const struct c2_rpc_packet *packet);

/**
   Returns true iff item is included in packet.
 */
C2_INTERNAL bool c2_rpc_packet_is_carrying_item(const struct c2_rpc_packet
						*packet,
 ...
 */
C2_INTERNAL int c2_rpc_packet_encode(struct c2_rpc_packet *packet,
 ...
 */
C2_INTERNAL int c2_rpc_packet_decode(struct c2_rpc_packet *packet,
				     struct c2_bufvec *bufvec,
 ...
 */
C2_INTERNAL int c2_rpc_packet_decode_using_cursor(struct c2_rpc_packet *packet,
						  struct c2_bufvec_cursor
