 ...
 */
C2_INTERNAL void c2_rpc_conn_establish_reply_received(struct c2_rpc_item *req);
 ...
 */
C2_INTERNAL void c2_rpc_conn_terminate_reply_received(struct c2_rpc_item *req);
