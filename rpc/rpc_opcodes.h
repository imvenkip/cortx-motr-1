...
enum C2_RPC_OPCODES {
	...
	/** Stob IO rpc opcodes */
	C2_STOB_IO_CREATE_REQ_OPCODE = 26,
	C2_STOB_IO_WRITE_REQ_OPCODE = 27,
	C2_STOB_IO_READ_REQ_OPCODE = 28,
	C2_STOB_IO_CREATE_REPLY_OPCODE = 29,
	C2_STOB_IO_WRITE_REPLY_OPCODE = 30,
	C2_STOB_IO_READ_REPLY_OPCODE = 31,
