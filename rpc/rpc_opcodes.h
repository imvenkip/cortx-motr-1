...
enum C2_RPC_OPCODES {
	...
	C2_CONF_FETCH_RESP_OPCODE           = 52,
        ...
        /* Mdservice fops */
        C2_MDSERVICE_CREATE_OPCODE          = 60,
        C2_MDSERVICE_LOOKUP_OPCODE          = 61,
        C2_MDSERVICE_LINK_OPCODE            = 62,
        C2_MDSERVICE_UNLINK_OPCODE          = 63,
        C2_MDSERVICE_RENAME_OPCODE          = 64,
        C2_MDSERVICE_OPEN_OPCODE            = 65,
        C2_MDSERVICE_CLOSE_OPCODE           = 66,
        C2_MDSERVICE_SETATTR_OPCODE         = 67,
        C2_MDSERVICE_GETATTR_OPCODE         = 68,
        C2_MDSERVICE_STATFS_OPCODE          = 69,
        C2_MDSERVICE_READDIR_OPCODE         = 70,
        C2_MDSERVICE_CREATE_REP_OPCODE      = 71,
        C2_MDSERVICE_LOOKUP_REP_OPCODE      = 72,
        C2_MDSERVICE_LINK_REP_OPCODE        = 73,
        C2_MDSERVICE_UNLINK_REP_OPCODE      = 74,
        C2_MDSERVICE_RENAME_REP_OPCODE      = 75,
        C2_MDSERVICE_OPEN_REP_OPCODE        = 76,
        C2_MDSERVICE_CLOSE_REP_OPCODE       = 77,
        C2_MDSERVICE_SETATTR_REP_OPCODE     = 78,
        C2_MDSERVICE_GETATTR_REP_OPCODE     = 79,
        C2_MDSERVICE_STATFS_REP_OPCODE      = 80,
