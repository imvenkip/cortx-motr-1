...
enum C2_RPC_OPCODES {
	...
	C2_CONF_UPDATE_RESP_OPCODE          = 54,
        ...
        C2_MDSERVICE_LOOKUP_OPCODE          = 54,
        C2_MDSERVICE_LINK_OPCODE            = 55,
        C2_MDSERVICE_UNLINK_OPCODE          = 56,
        C2_MDSERVICE_RENAME_OPCODE          = 57,
        C2_MDSERVICE_OPEN_OPCODE            = 58,
        C2_MDSERVICE_CLOSE_OPCODE           = 59,
        C2_MDSERVICE_SETATTR_OPCODE         = 60,
        C2_MDSERVICE_GETATTR_OPCODE         = 61,
        C2_MDSERVICE_STATFS_OPCODE          = 62,
        C2_MDSERVICE_READDIR_OPCODE         = 63,
        C2_MDSERVICE_CREATE_REP_OPCODE      = 64,
        C2_MDSERVICE_LOOKUP_REP_OPCODE      = 65,
        C2_MDSERVICE_LINK_REP_OPCODE        = 66,
        C2_MDSERVICE_UNLINK_REP_OPCODE      = 67,
        C2_MDSERVICE_RENAME_REP_OPCODE      = 68,
        C2_MDSERVICE_OPEN_REP_OPCODE        = 69,
        C2_MDSERVICE_CLOSE_REP_OPCODE       = 70,
        C2_MDSERVICE_SETATTR_REP_OPCODE     = 71,
        C2_MDSERVICE_GETATTR_REP_OPCODE     = 72,
        C2_MDSERVICE_STATFS_REP_OPCODE      = 73,
        C2_MDSERVICE_READDIR_REP_OPCODE     = 74,

	C2_SNS_REPAIR_TRIGGER_OPCODE        = 75,
	C2_SNS_REPAIR_TRIGGER_REP_OPCODE    = 76
};
