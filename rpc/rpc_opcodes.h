...
enum M0_RPC_OPCODES {
	...
	/* Stats fops */
	M0_STATS_UPDATE_FOP_OPCODE          = 110,
	M0_STATS_QUERY_FOP_OPCODE           = 111,
	M0_STATS_QUERY_REP_FOP_OPCODE       = 112,

	/* DTM */
	M0_DTM_NOTIFICATION_OPCODE          = 113,
	M0_DTM_UP_OPCODE                    = 114,

	/* High Availability opcodes */
	M0_HA_NOTE_GET_OPCODE               = 115,
	M0_HA_NOTE_GET_REP_OPCODE           = 116,
	...
	/* fsync fops */
	M0_FSYNC_MDS_OPCODE                 = 120,
	M0_FSYNC_MDS_REP_OPCODE             = 121,
	M0_FSYNC_IOS_OPCODE                 = 122,
	M0_FSYNC_IOS_REP_OPCODE             = 123,

	/* cob getattr & reply */
	M0_IOSERVICE_COB_GETATTR_OPCODE     = 130,
	M0_IOSERVICE_COB_GETATTR_REP_OPCODE = 131,
};
